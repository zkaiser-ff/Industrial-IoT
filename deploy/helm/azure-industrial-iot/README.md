...
Here are the steps to [create AAD App Registrations](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/deploy/howto-register-aad-applications.md).
...
This chart installs `2.7.170` version of components by default.
...
**Documentation**: [Publisher Edge Module](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/modules/publisher.md)
...
**Documentation**: [Azure Industrial IoT Platform Components](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/readme.md)
...
|-------------------------|----------------------------------------------------------------------------------------------------------------------------|--------------------|
| `registry`              | [Registry Microservice](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/registry.md)                 | `true`             |
| `sync`                  | [Registry Synchronization Agent](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/registry-sync.md)   | `true`             |
| `twin`                  | [OPC Twin Microservice](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/twin.md)                     | `true`             |
| `history`               | [OPC Historian Access Microservice](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/twin-history.md) | `true`             |
| `gateway`               | [OPC Gateway Microservice](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/twin-gateway.md)          | `true`             |
| `vault`                 | [OPC Vault Microservice](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/vault.md)                   | `true`             |
| `publisher`             | [OPC Publisher Service](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/publisher.md)                | `true`             |
| `events`                | [Events Service](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/events.md)                          | `true`             |
| `edgeJobs`              | [Publisher jobs orchestrator service](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/publisher.md)  | `true`             |
| `onboarding`            | [Onboarding Processor](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/processor-onboarding.md)      | `true`             |
| `eventsProcessor`       | [Edge Event Processor](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/processor-events.md)          | `true`             |
| `telemetryCdmProcessor` | [Datalake export](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/processor-telemetry-cdm.md)        | `false`            |
| `telemetryProcessor`    | [Edge Telemetry processor](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/processor-telemetry.md)   | `true`             |
| `tunnelProcessor`       | [Http Tunnel processor](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/processor-tunnel.md)         | `true`             |
| `engineeringTool`       | [Engineering Tool](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/services/engineeringtool.md)               | `false`            |
...
[how to connect Power BI with Azure Data Lake Storage Gen2 and visualize publisher telemetry](https://github.com/Azure/Industrial-IoT/blob/helm_0.3.1/docs/tutorials/tut-power-bi-cdm.md).
